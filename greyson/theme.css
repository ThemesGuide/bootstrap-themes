...
.was-validated .custom-control-input:valid:focus ~ .custom-control-label::before, .custom-control-input.is-valid:focus ~ .custom-control-label::before {
  box-shadow: 0 0 0 1px #fff, 0 0 0 0.2rem rgba(62, 77, 89, 0.25); }
...
.invalid-tooltip {
  ...
  line-height: 1;
  color: #fff;
  background-color: rgba(204, 51, 13, 0.8);
  border-radius: .2rem; }
...
.was-validated .custom-control-input:invalid:focus ~ .custom-control-label::before, .custom-control-input.is-invalid:focus ~ .custom-control-label::before {
  box-shadow: 0 0 0 1px #fff, 0 0 0 0.2rem rgba(204, 51, 13, 0.25); }
...
.custom-select {
  ...
  .custom-select:focus {
    border-color: #617c95;
    outline: 0;
    box-shadow: inset 0 1px 2px rgba(0, 0, 0, 0.075), 0 0 5px rgba(97, 124, 149, 0.5); }
...
a.text-info:hover, a.text-info:focus {
  color: #487175 !important; }

.text-warning {
  color: #6e9fa5 !important; }

a.text-warning:hover, a.text-warning:focus {
  color: #56848a !important; }

.text-danger {
  color: #cc330d !important; }

a.text-danger:hover, a.text-danger:focus {
  color: #9c270a !important; }
